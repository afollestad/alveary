...
9. For push-triggered releases, generate header-free release notes with `scripts/ci/generate-release-notes.sh`. Notes cover user-facing changes only, grouped into bold theme bullets with indented italic child bullets that merge related commits.
