...
final class AppComponentTests: XCTestCase {
    func testContainerScopedServicesReturnStableInstances() throws {
        ...
        assertSameInstance(component.pullRequestsService, component.pullRequestsService)
        assertSameInstance(component.gitHubAvatarLoader, component.gitHubAvatarLoader)
        assertSameInstance(component.pullRequestsListCache, component.pullRequestsListCache)
    ...
    func testScheduledTaskServicesAreAppScopedAndIdleWhenResolved() {
        ...
        _ = component.scheduledTaskRecoveryReadinessValidator
