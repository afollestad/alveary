...
final class HarnessSetupServiceTests: XCTestCase {
    ...
    func testTrustProjectUpdatesClaudeTrustStatus() async throws {
        ...
        XCTAssertEqual(
            fixture.service.cachedProjectTrustStatus(harnessId: "claude", workingDirectory: workingDirectory.path),
            true
        )
    }
    ...
    func testOtherHarnessesDoNotRequireProjectTrust() async throws {
        let fixture = try makeFixture()
        defer { fixture.cleanup() }
    ...
    func testPrepareForSpawnForOtherHarnessesIsNoOp() async throws {
        let fixture = try makeFixture()
        defer { fixture.cleanup() }
        let workingDirectory = try fixture.makeWorkingDirectory(named: "project")
    ...
    private func makeFixture() throws -> TestFixture {
        ...
        let setup = AgentCLIKit.ClaudeHarnessSetup(configStore: store)
        return TestFixture(
            homeDirectory: homeDirectory,
            service: DefaultHarnessSetupService(
...
private struct TestFixture {
    ...
    let service: DefaultHarnessSetupService
