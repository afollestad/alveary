...
/// Says what the drop grants and what the Task keeps, and deliberately names no sidebar section —
/// a pinned Task sits under `Pinned` rather than `Tasks`, so any section named here would be wrong
/// half the time.
