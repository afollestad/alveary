...
- Do not swap task rows back to `NSProgressIndicator`; transcript AppKit spinner behavior is centralized in `Alveary/Views/Components/AppKit/AppKitStatusIndicatorSpinner.swift`.
