...
- Hide the conversation tab strip and disable `New Conversation` commands until the main thread completes initial setup. Additional conversations have no usable runtime context before that boundary.
