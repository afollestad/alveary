...
- **Preserve public names.** Keep `AppMarkdownText`, `DeferredAppMarkdownText`, `AppMarkdownInlineLabel`, and `AppMarkdownInlineParagraph` available for non-transcript surfaces.
