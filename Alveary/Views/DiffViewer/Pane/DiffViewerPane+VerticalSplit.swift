...
/// The shared top/bottom split for every pane mode: split height, the drag
/// handle, and the handle's accessibility all live here so a mode cannot grow
/// its own resize behavior. Each mode still persists its own `splitFraction`.
