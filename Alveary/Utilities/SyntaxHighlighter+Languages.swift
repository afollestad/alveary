...
/// The per-language token rules `SyntaxHighlighter` matches against. Split out of the highlighter
/// itself so the table can grow without pushing that file past the repo's file-length limit.
