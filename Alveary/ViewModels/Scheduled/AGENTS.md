...
- Keep the review suggestion's skip names aligned with `PullRequestAgenticThreadService.Kind.threadName` in `Alveary/Services/PullRequests/PullRequestAgenticThreadService.swift`; existing review tasks are its cross-run ledger.
