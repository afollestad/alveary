...
extension AgentCLIKit.AgentInputAttachment {
    init(localImageAttachment attachment: LocalImageAttachment) {
        self = .localImage(id: attachment.id, fileURL: attachment.fileURL)
    }
}
